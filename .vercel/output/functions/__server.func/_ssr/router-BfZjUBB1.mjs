...
import { c as createRootRouteWithContext, H as HeadContent, S as Scripts, O as Outlet, a as createFileRoute, l as lazyRouteComponent, b as createRouter, L as Link, u as useRouter } from "../_libs/tanstack__react-router.mjs";
...
const appCss = "/assets/styles-DCEDxVhi.css";
...
__name(reportLovableError, "reportLovableError");
__name2(reportLovableError, "reportLovableError");
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-6", "data-tsd-source": "/src/routes/__root.tsx:17:5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", "data-tsd-source": "/src/routes/__root.tsx:18:7", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-widest text-primary font-bold mb-6", "data-tsd-source": "/src/routes/__root.tsx:19:9", children: "404 // Not Found" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-6xl font-bold tracking-tight text-foreground", "data-tsd-source": "/src/routes/__root.tsx:22:9", children: "Off the syllabus." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-muted-foreground", "data-tsd-source": "/src/routes/__root.tsx:25:9", children: "The page you're looking for doesn't exist or has been moved." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8", "data-tsd-source": "/src/routes/__root.tsx:28:9", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: "/",
        ...
        "data-tsd-source": "/src/routes/__root.tsx:29:11",
        children: "Return home"
      }
    ) })
  ] }) });
}
__name(NotFoundComponent, "NotFoundComponent");
__name2(NotFoundComponent, "NotFoundComponent");
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-6", "data-tsd-source": "/src/routes/__root.tsx:49:5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", "data-tsd-source": "/src/routes/__root.tsx:50:7", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-widest text-primary font-bold mb-6", "data-tsd-source": "/src/routes/__root.tsx:51:9", children: "Runtime Error" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl font-bold tracking-tight text-foreground", "data-tsd-source": "/src/routes/__root.tsx:54:9", children: "This page didn't load." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-muted-foreground", "data-tsd-source": "/src/routes/__root.tsx:57:9", children: "Something went wrong on our end. Try refreshing or head back home." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex flex-wrap justify-center gap-3", "data-tsd-source": "/src/routes/__root.tsx:60:9", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          "data-tsd-source": "/src/routes/__root.tsx:61:11",
          children: "Try again"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          ...
          "data-tsd-source": "/src/routes/__root.tsx:70:11",
          children: "Go home"
        }
      )
    ] })
...
__name2(ErrorComponent, "ErrorComponent");
const Route$k = createRootRouteWithContext()({
  head: /* @__PURE__ */ __name2(() => ({
    meta: [
      { charSet: "utf-8" },
...
function RootShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "en", "data-tsd-source": "/src/routes/__root.tsx:117:5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("head", { "data-tsd-source": "/src/routes/__root.tsx:118:7", children: /* @__PURE__ */ jsxRuntimeExports.jsx(HeadContent, { "data-tsd-source": "/src/routes/__root.tsx:119:9" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("body", { "data-tsd-source": "/src/routes/__root.tsx:121:7", children: [
      children,
      /* @__PURE__ */ jsxRuntimeExports.jsx(Scripts, { "data-tsd-source": "/src/routes/__root.tsx:123:9" })
    ] })
  ] });
}
__name(RootShell, "RootShell");
__name2(RootShell, "RootShell");
function RootComponent() {
  const { queryClient } = Route$k.useRouteContext();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, "data-tsd-source": "/src/routes/__root.tsx:133:5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, { "data-tsd-source": "/src/routes/__root.tsx:134:7" }) });
}
__name(RootComponent, "RootComponent");
__name2(RootComponent, "RootComponent");
const $$splitComponentImporter$d = /* @__PURE__ */ __name2(() => import("./training-ukJ-4ESd.mjs"), "$$splitComponentImporter$d");
...
const $$splitComponentImporter$c = /* @__PURE__ */ __name2(() => import("./terms-B264R548.mjs"), "$$splitComponentImporter$c");
...
const $$splitComponentImporter$b = /* @__PURE__ */ __name2(() => import("./team-CwyKot3d.mjs"), "$$splitComponentImporter$b");
...
const $$splitComponentImporter$a = /* @__PURE__ */ __name2(() => import("./support-CwiMj6D4.mjs"), "$$splitComponentImporter$a");
...
const $$splitComponentImporter$9 = /* @__PURE__ */ __name2(() => import("./resources-BO5LG9M7.mjs"), "$$splitComponentImporter$9");
...
const $$splitComponentImporter$8 = /* @__PURE__ */ __name2(() => import("./register-9X4Nixn_.mjs"), "$$splitComponentImporter$8");
...
const $$splitComponentImporter$7 = /* @__PURE__ */ __name2(() => import("./privacy-DBDLmhX4.mjs"), "$$splitComponentImporter$7");
...
const $$splitComponentImporter$6 = /* @__PURE__ */ __name2(() => import("./news-BXqBKpyU.mjs"), "$$splitComponentImporter$6");
...
const $$splitComponentImporter$5 = /* @__PURE__ */ __name2(() => import("./events-apgLKsSa.mjs"), "$$splitComponentImporter$5");
...
const $$splitComponentImporter$4 = /* @__PURE__ */ __name2(() => import("./contact-LJPVgtKp.mjs"), "$$splitComponentImporter$4");
...
const $$splitComponentImporter$3 = /* @__PURE__ */ __name2(() => import("./competition-CFs2gUZF.mjs"), "$$splitComponentImporter$3");
...
__name2(encodeSession, "encodeSession");
...
__name2(decodeSession, "decodeSession");
...
__name2(buildSetCookie, "buildSetCookie");
function buildClearCookie() {
  return `${COOKIE_NAME}=; Path=/; HttpOnly; SameSite=Lax; Max-Age=0`;
}
__name(buildClearCookie, "buildClearCookie");
__name2(buildClearCookie, "buildClearCookie");
const $$splitComponentImporter$2 = /* @__PURE__ */ __name2(() => import("./admin-OXUUlmWB.mjs"), "$$splitComponentImporter$2");
...
const $$splitComponentImporter$1 = /* @__PURE__ */ __name2(() => import("./about-Cy6PBWDW.mjs"), "$$splitComponentImporter$1");
...
const $$splitComponentImporter = /* @__PURE__ */ __name2(() => import("./index-BseoEJJD.mjs"), "$$splitComponentImporter");
...
__name(readContentFile, "readContentFile");
__name2(readContentFile, "readContentFile");
...
__name(writeContentFile, "writeContentFile");
__name2(writeContentFile, "writeContentFile");
...
__name2(getGitHubUser, "getGitHubUser");
const Route$4 = createFileRoute("/api/admin/me")({
  server: {
    handlers: {
      GET: /* @__PURE__ */ __name2(async ({ request }) => {
...
const Route$3 = createFileRoute("/api/admin/content/$file")({
  server: {
    handlers: {
      GET: /* @__PURE__ */ __name2(async ({ request, params }) => {
        const json = /* @__PURE__ */ __name2((body, status = 200) => new Response(JSON.stringify(body), {
          status,
          headers: { "Content-Type": "application/json" }
        }), "json");
      ...
      PUT: /* @__PURE__ */ __name2(async ({ request, params }) => {
        const json = /* @__PURE__ */ __name2((body2, status = 200) => new Response(JSON.stringify(body2), {
          status,
          headers: { "Content-Type": "application/json" }
        }), "json");
        const token = await getSession(request);
...
const TrainingRoute = Route$j.update({
  id: "/training",
  path: "/training",
  getParentRoute: /* @__PURE__ */ __name2(() => Route$k, "getParentRoute")
});
...
const getRouter = /* @__PURE__ */ __name2(() => {
