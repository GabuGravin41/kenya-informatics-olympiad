...
import { y as defineHandlerCallback, z as resolveManifestAssetLink, u as resolveManifestCssLink, k as rootRouteId, A as defaultSerovalPlugins, C as makeSerovalPlugin, s as getScriptPreloadAttrs, D as getStylesheetHref, E as mergeHeaders, m as isRedirect, F as isSsrResponse, G as getNormalizedURL, H as getOrigin, I as normalizeSsrResponse, J as attachRouterServerSsrUtils, K as isResolvedRedirect, L as replaceSsrResponse, M as executeRewriteInput, N as stripSsrResponseBody, O as createSerializationAdapter, P as createRawStreamRPCPlugin, i as invariant, g as isNotFound } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DNUjLFaR.mjs");
...
var createMiddleware = /* @__PURE__ */ __name2((options, __opts) => {
  const resolvedOptions = {
    type: "request",
    ...__opts || options
  };
  const setValidator = /* @__PURE__ */ __name2((validator) => {
  ...
  return {
    ...
    client: /* @__PURE__ */ __name2((client) => {
      return createMiddleware({}, Object.assign(resolvedOptions, { client }));
    }, "client"),
    server: /* @__PURE__ */ __name2((server2) => {
      return createMiddleware({}, Object.assign(resolvedOptions, { server: server2 }));
    }, "server")
  };
}, "createMiddleware");
var innerCreateCsrfMiddleware = /* @__PURE__ */ __name2((opts = {}) => {
  ...
  return middleware;
}, "innerCreateCsrfMiddleware");
var createCsrfMiddleware = innerCreateCsrfMiddleware;
async function isCsrfRequestAllowed(opts, ctx) {
  const result = await getCsrfRequestValidationResult(opts, ctx);
  return result === true || result === void 0 && opts.allowRequestsWithoutOriginCheck === true;
}
__name(isCsrfRequestAllowed, "isCsrfRequestAllowed");
__name2(isCsrfRequestAllowed, "isCsrfRequestAllowed");
...
__name(getCsrfRequestValidationResult, "getCsrfRequestValidationResult");
__name2(getCsrfRequestValidationResult, "getCsrfRequestValidationResult");
...
__name(getOriginFromUrl, "getOriginFromUrl");
__name2(getOriginFromUrl, "getOriginFromUrl");
...
__name(isRefererSameOrigin, "isRefererSameOrigin");
__name2(isRefererSameOrigin, "isRefererSameOrigin");
...
__name(getFailureResponse, "getFailureResponse");
__name2(getFailureResponse, "getFailureResponse");
...
__name(buildLinkParam, "buildLinkParam");
__name2(buildLinkParam, "buildLinkParam");
...
__name(serializeEarlyHint, "serializeEarlyHint");
__name2(serializeEarlyHint, "serializeEarlyHint");
function getStringAttr(attrs, name, fallbackName) {
  const value = attrs?.[name] ?? (fallbackName ? attrs?.[fallbackName] : void 0);
  return typeof value === "string" ? value : void 0;
}
__name(getStringAttr, "getStringAttr");
__name2(getStringAttr, "getStringAttr");
function getPreloadAs(attrs) {
  const as = getStringAttr(attrs, "as");
  return as && PRELOAD_AS_VALUES.has(as) ? as : void 0;
}
__name(getPreloadAs, "getPreloadAs");
__name2(getPreloadAs, "getPreloadAs");
...
__name(addEarlyHintFetchAttrs, "addEarlyHintFetchAttrs");
__name2(addEarlyHintFetchAttrs, "addEarlyHintFetchAttrs");
...
__name(linkAttrsToEarlyHint, "linkAttrsToEarlyHint");
__name2(linkAttrsToEarlyHint, "linkAttrsToEarlyHint");
...
__name(collectStaticHintsFromManifest, "collectStaticHintsFromManifest");
__name2(collectStaticHintsFromManifest, "collectStaticHintsFromManifest");
...
__name(collectDynamicHintsFromMatches, "collectDynamicHintsFromMatches");
__name2(collectDynamicHintsFromMatches, "collectDynamicHintsFromMatches");
...
__name(createEarlyHintsEvent, "createEarlyHintsEvent");
__name2(createEarlyHintsEvent, "createEarlyHintsEvent");
...
__name(createResponseLinkHeaderEntries, "createResponseLinkHeaderEntries");
__name2(createResponseLinkHeaderEntries, "createResponseLinkHeaderEntries");
...
__name(getResponseLinkHeaderEntries, "getResponseLinkHeaderEntries");
__name2(getResponseLinkHeaderEntries, "getResponseLinkHeaderEntries");
...
__name(notifyEarlyHints, "notifyEarlyHints");
__name2(notifyEarlyHints, "notifyEarlyHints");
function getResponseLinkHeaderFilter(responseLinkHeader) {
  if (typeof responseLinkHeader !== "object") return;
  return responseLinkHeader.filter;
}
__name(getResponseLinkHeaderFilter, "getResponseLinkHeaderFilter");
__name2(getResponseLinkHeaderFilter, "getResponseLinkHeaderFilter");
function appendResponseLinkHeaders(opts) {
  for (const link of getResponseLinkHeaderEntries(opts)) opts.responseHeaders.append("Link", link);
}
__name(appendResponseLinkHeaders, "appendResponseLinkHeaders");
__name2(appendResponseLinkHeaders, "appendResponseLinkHeaders");
...
__name(collectResponseLinkHeaderEntries, "collectResponseLinkHeaderEntries");
__name2(collectResponseLinkHeaderEntries, "collectResponseLinkHeaderEntries");
...
__name(collectEarlyHintsPhase, "collectEarlyHintsPhase");
__name2(collectEarlyHintsPhase, "collectEarlyHintsPhase");
function createEarlyHintsCollector(opts) {
  ...
  return {
    collectStatic: /* @__PURE__ */ __name2(({ manifest: manifest2, matchedRoutes }) => {
    ...
    collectDynamic: /* @__PURE__ */ __name2((matches) => {
      collectEarlyHintsPhase({
        phase: "dynamic",
    ...
    appendResponseHeaders: /* @__PURE__ */ __name2((headers) => {
...
__name(createEarlyHintsCollector, "createEarlyHintsCollector");
__name2(createEarlyHintsCollector, "createEarlyHintsCollector");
...
__name2(escapeCssString, "escapeCssString");
...
__name(transformInlineCssTemplate, "transformInlineCssTemplate");
__name2(transformInlineCssTemplate, "transformInlineCssTemplate");
...
__name(transformInlineCssStyles, "transformInlineCssStyles");
__name2(transformInlineCssStyles, "transformInlineCssStyles");
...
__name(assignManifestLink, "assignManifestLink");
__name2(assignManifestLink, "assignManifestLink");
async function transformManifestAssets(source, transformFn, _opts) {
  const manifest2 = structuredClone(source);
  const inlineCssEnabled = _opts?.inlineCss !== false;
  const scriptTransforms = /* @__PURE__ */ new Map();
  const transformScript = /* @__PURE__ */ __name2((url) => {
...
__name2(buildManifest, "buildManifest");
function getStaticHandlerInlineCssDefault(handlerInlineCss) {
  if (typeof handlerInlineCss === "function") return;
  return handlerInlineCss ?? true;
}
__name(getStaticHandlerInlineCssDefault, "getStaticHandlerInlineCssDefault");
__name2(getStaticHandlerInlineCssDefault, "getStaticHandlerInlineCssDefault");
async function resolveInlineCssForRequest(opts) {
  if (opts.requestInlineCss !== void 0) return opts.requestInlineCss;
  if (typeof opts.handlerInlineCss === "function") return await opts.handlerInlineCss({ request: opts.request });
  return opts.handlerInlineCss ?? true;
}
__name(resolveInlineCssForRequest, "resolveInlineCssForRequest");
__name2(resolveInlineCssForRequest, "resolveInlineCssForRequest");
...
__name(createCachedBaseManifestLoader, "createCachedBaseManifestLoader");
__name2(createCachedBaseManifestLoader, "createCachedBaseManifestLoader");
function createFinalManifestTransformResolver(transformAssets, opts) {
  const transformConfig = transformAssets !== void 0 ? resolveTransformAssetsConfig(transformAssets) : void 0;
  const cache = transformConfig ? transformConfig.cache : true;
  const warmup = !!transformAssets && typeof transformAssets === "object" && "warmup" in transformAssets && transformAssets.warmup === true;
  let cachedCreateTransformPromise;
  const clearCachedCreateTransform = /* @__PURE__ */ __name2(() => {
  ...
  return {
    ...
    warmup,
    clearCachedCreateTransform,
    getTransformFn: /* @__PURE__ */ __name2(async (ctx) => {
...
__name(createFinalManifestTransformResolver, "createFinalManifestTransformResolver");
__name2(createFinalManifestTransformResolver, "createFinalManifestTransformResolver");
function createFinalManifestResolver(opts) {
  const finalManifestCache = /* @__PURE__ */ new Map();
  const transformResolver = createFinalManifestTransformResolver(opts.transformAssets);
  const handlerDefaultInlineCss = getStaticHandlerInlineCssDefault(opts.inlineCss);
  const getRequestManifestOptions = /* @__PURE__ */ __name2(async (requestOpts) => {
  ...
  }, "getRequestManifestOptions");
  const resolveRequest = /* @__PURE__ */ __name2(async (requestOpts, cache) => {
  ...
  return {
    warmup: /* @__PURE__ */ __name2(({ getBaseManifest: getBaseManifest2 }) => warmupFinalManifest({
      enabled: transformResolver.warmup,
      handlerDefaultInlineCss,
      cache: transformResolver.cache,
      finalManifestCache,
      getBaseManifest: getBaseManifest2,
      getTransformFn: /* @__PURE__ */ __name2(() => transformResolver.getTransformFn({ warmup: true }), "getTransformFn"),
      onError: transformResolver.clearCachedCreateTransform
    }), "warmup"),
    resolveCached: /* @__PURE__ */ __name2((requestOpts) => resolveRequest(requestOpts, finalManifestCache), "resolveCached"),
    resolveUncached: /* @__PURE__ */ __name2((requestOpts) => resolveRequest(requestOpts, void 0), "resolveUncached")
  };
}
__name(createFinalManifestResolver, "createFinalManifestResolver");
__name2(createFinalManifestResolver, "createFinalManifestResolver");
function getFinalManifestCacheKey(inlineCss) {
  return inlineCss ? "inline-css" : "linked-css";
}
__name(getFinalManifestCacheKey, "getFinalManifestCacheKey");
__name2(getFinalManifestCacheKey, "getFinalManifestCacheKey");
...
__name(cacheFinalManifestPromise, "cacheFinalManifestPromise");
__name2(cacheFinalManifestPromise, "cacheFinalManifestPromise");
function getOrCreateCachedFinalManifestPromise(cachedFinalManifestPromises, cacheKey, computeFinalManifest) {
  const cachedFinalManifestPromise = cachedFinalManifestPromises.get(cacheKey);
  if (cachedFinalManifestPromise) return cachedFinalManifestPromise;
  return cacheFinalManifestPromise(cachedFinalManifestPromises, cacheKey, Promise.resolve().then(computeFinalManifest));
}
__name(getOrCreateCachedFinalManifestPromise, "getOrCreateCachedFinalManifestPromise");
__name2(getOrCreateCachedFinalManifestPromise, "getOrCreateCachedFinalManifestPromise");
async function buildFinalManifest(opts) {
  return opts.transformFn ? await transformManifestAssets(opts.base, opts.transformFn, { inlineCss: opts.inlineCss }) : buildManifest(opts.base, { inlineCss: opts.inlineCss });
}
__name(buildFinalManifest, "buildFinalManifest");
__name2(buildFinalManifest, "buildFinalManifest");
...
__name(resolveFinalManifest, "resolveFinalManifest");
__name2(resolveFinalManifest, "resolveFinalManifest");
...
__name(warmupFinalManifest, "warmupFinalManifest");
__name2(warmupFinalManifest, "warmupFinalManifest");
...
var defaultCsrfMiddleware = createCsrfMiddleware({ filter: /* @__PURE__ */ __name2((ctx) => ctx.handlerType === "serverFn", "filter") });
var getCachedBaseManifest = createCachedBaseManifestLoader(() => getStartManifest());
var getProdBaseManifest = /* @__PURE__ */ __name2(() => getCachedBaseManifest(), "getProdBaseManifest");
var getBaseManifest = getProdBaseManifest;
var createEarlyHintsForRequest = createEarlyHintsCollector;
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BfZjUBB1.mjs").then((n) => n.r),
    import("./start-bYfDCPlr.mjs"),
...
__name(warnMissingCsrfMiddlewareOnce, "warnMissingCsrfMiddlewareOnce");
__name2(warnMissingCsrfMiddlewareOnce, "warnMissingCsrfMiddlewareOnce");
var ROUTER_BASEPATH = "/";
...
async function executeMiddleware(middlewares, ctx) {
  let index = -1;
  let streamResponse;
  const setResponse = /* @__PURE__ */ __name2((response) => {
  ...
  const disposeStreamResponse = /* @__PURE__ */ __name2(async (reason) => {
  ...
  }, "disposeStreamResponse");
  const getFinalResponse = /* @__PURE__ */ __name2(async () => {
...
function createStartHandler(cbOrOptions) {
  ...
  finalManifestResolver.warmup({ getBaseManifest: /* @__PURE__ */ __name2(() => getBaseManifest(), "getBaseManifest") });
    ...
    try {
      ...
      const executeRouter = /* @__PURE__ */ __name2(async (serverContext, matchedRoutes) => {
        ...
        const manifest2 = await resolveManifestForRequest({
          ...
          getBaseManifest: /* @__PURE__ */ __name2(() => getBaseManifest(matchedRoutes), "getBaseManifest")
        });
